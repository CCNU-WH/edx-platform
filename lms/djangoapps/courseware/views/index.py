...
from .views import CourseTabView, ensure_access_to_course
...
class CoursewareIndex(View):
    ...
    def get(self, request, course_id, chapter=None, section=None, position=None):
        ...
        try:
            ...
            return CourseTabView.handle_unexpected_error(request, self.course, exception)
    ...
    def _get(self, request):
        ...
        """
        ensure_access_to_course(request, self.course)
