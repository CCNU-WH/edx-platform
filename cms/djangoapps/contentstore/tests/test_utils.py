...
class GroupVisibilityTest(CourseTestCase):
    ...
    def test_no_visibility_set(self):
        ...
        def verify_all_components_visible_to_all():  # pylint: disable=invalid-name
            ...
            for item in (self.sequential, self.vertical, self.html, self.problem):
                self.assertFalse(utils.has_children_visible_to_specific_partiton_groups(item))
    ...
    def test_sequential_and_problem_have_group_access(self):
        ...
        self.assertFalse(utils.has_children_visible_to_specific_partiton_groups(self.sequential))
        self.assertTrue(utils.has_children_visible_to_specific_partiton_groups(self.vertical))
        self.assertFalse(utils.has_children_visible_to_specific_partiton_groups(self.html))
        self.assertFalse(utils.has_children_visible_to_specific_partiton_groups(self.problem))
